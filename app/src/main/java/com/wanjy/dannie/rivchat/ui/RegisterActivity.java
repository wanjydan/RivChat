...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wanjy.dannie.rivchat.R.layout.activity_register);
        fab = (FloatingActionButton) findViewById(com.wanjy.dannie.rivchat.R.id.fab);
        cvAdd = (CardView) findViewById(com.wanjy.dannie.rivchat.R.id.cv_add);
        ...
        editTextRepeatPassword = (EditText) findViewById(com.wanjy.dannie.rivchat.R.id.et_repeatpassword);
    ...
    private void ShowEnterAnimation() {
        Transition transition = TransitionInflater.from(this).inflateTransition(com.wanjy.dannie.rivchat.R.transition.fabtransition);
    ...
    public void animateRevealClose() {
        ...
        mAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                super.onAnimationEnd(animation);
                fab.setImageResource(com.wanjy.dannie.rivchat.R.drawable.ic_signup);
